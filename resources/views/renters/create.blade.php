                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="fb_id" class="form-control" value="{{old('fb_id')}}"
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="e_back" class="form-control" value="{{old('e_back')}}"
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select name="rent_payer" class="custom-select rounded-0">
                        <option value="">--Rent Payer--</option>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="date" name="rent_from" class="form-control" value="{{old('rent_from')}}"
