                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <select name="expense_type" class="custom-select rounded-0">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{old('expense_name')}}" name="expense_name" class="form-control" placeholder="Enter Expense Name">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="date" value="{{old('ex_date')}}" name="ex_date" class="form-control" placeholder="Enter date">
                      </div>
                    </div>
