                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select name="expense_type" class="custom-select rounded-0" id="exampleSelectRounded0">
                        ...
                        <option value="{{ $item->id }}" {{$expense->expense_type == $item->id ? 'selected' : ''}}>{{
                          $item->ex_typ_name}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select name="home_id" class="custom-select rounded-0">
                        ...
                        <option value="{{ $item->id }}" {{$expense->home_id == $item->id ? 'selected' : ''}}>{{
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="expense_name" value="{{$expense->expense_name}}" class="form-control"
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="date" name="ex_date" value="{{$expense->ex_date}}" class="form-control"
                  ...
                  <div class="col-md-9">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="ex_des" rows="3"
                        placeholder="Enter ...">{{$expense->ex_des}}</textarea>
                    </div>
                  </div>
                </div>
              </div>
