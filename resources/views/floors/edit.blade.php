                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="floor_number" value="{{$floor->floor_number}}" class="form-control"
                    ...
                    <div class="form-group">
                      ...
                      <select name="home_id" class="custom-select rounded-0">
                        ...
                        @foreach($home as $item)
                          <option value="{{ $item->id }}" {{$floor->home_id == $item->id  ? 'selected' : ''}}>{{ $item->home_name}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
